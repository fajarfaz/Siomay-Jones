...
?>
        ...
        <!-- /. NAV SIDE  -->
        <?php
        $jml=mysqli_query($conn,"SELECT COUNT(id)  FROM tb_event ORDER BY tanggal DESC");
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">DATA EVENT<span class="count" ><?php echo $jml[0];?></span></h1>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Pencarian Berdasarkan Nama Event..." title="Tulis Dengan Angka..." >
<table id="myTable">
  <tr class="header">
    
    <th style="width:20%;">Nama/Judul Event</th>
    <th style="width:15%;">Gambar</th>
    <th style="width:15%;">Masa Event</th>
...
<?php 
  function rupiah($angka){
    ...
    $qu=mysqli_query($conn,"SELECT * FROM tb_event ");
    while($has=mysqli_fetch_row($qu)){

echo "
  <tr>
    <td>$has[1]</td>
    <td><img src=' ../upload/$has[2]'></td>
    <td>$has[3] Sampai $has[5]</td>
    <td>$has[4]</td>
  
    <td>"?> <div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Action <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="edit_event.php?id=<?php echo $has[0];?>">Edit</a></li>
                                            <li class="divider"></li>
                                            <li><a href="delete_event.php?id=<?php echo $has[0];?>">Hapus</a></li>
                                        </ul>
                                    </div>
    <?php "</td>
  </tr>";
