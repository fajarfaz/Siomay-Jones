...
?>
                     ...
                     <li>
                      <li>
                        ...
                        <ul class="nav nav-second-level collapse in" style="">
                            ...
                            <li>
                                <a href="data_pegawai.php" class="active-menu"><i class="fa fa-edit "></i>Edit Data</a>
                            </li>
                           </ul>
                     <li>
                    <li>
        ...
        <!-- /. NAV SIDE  -->
        <?php
        $jml=mysqli_query($conn,"SELECT COUNT(nama)  FROM tb_karyawan ");
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">DATA DIRI PEGAWAI<span class="count" ><?php echo $jml[0];?></span></h1>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Pencarian Berdasarkan Nama Pegawai..." title="Tulis Dengan Angka..." >
<table id="myTable">
  <tr class="header">
    
    <th style="width:20%;">Nama</th>
    <th style="width:30%;">Alamat</th>
    <th style="width:20%;">Nomer Telepon</th>
...
<?php 
    $qu=mysqli_query($conn,"SELECT * FROM tb_karyawan");
    ...
    <td>"?> <div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Action <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="edit_pegawai.php?id=<?php echo $has[0];?>">Edit</a></li>
                                            <li class="divider"></li>
                                            <li><a href="delete_pegawai.php?id=<?php echo $has[0];?>">Hapus</a></li>
                                        </ul>
                                    </div>
    <?php "</td>
  </tr>";
