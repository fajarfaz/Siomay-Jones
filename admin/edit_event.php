                     ...
                     <li>
                        <a href="#"><i class="fa fa-coffee "></i>EVENT  <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in" style="">
                            ...
                            <li>
                                <a href="data_event.php" class="active-menu"><i class="fa fa-edit "></i>Edit Data</a>
                            </li>
                           <!--   <li>
                 ...
                 <form action="" method="POST" enctype="multipart/form-data" >
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_mulai"  value="<?php echo $row['tgl_berlaku'];?>" required>
                                            <p class="help-block">Masukkan tanggal dimulainya event</p>
                                        </div>
                                         <div class="form-group">
                                            <label>Tanggal Berakhir Event</label>
                                            <input type="date" class="form-control" name="tanggal_selesai" value="<?php echo $row['tgl_berakhir'];?>" required>
                                            <p class="help-block">Masukkan tanggal berakhirnya event</p>
                                        </div>
                                          
                                        <div class="form-group">
                                            <label>Keterangan Event</label>
                                           <textarea class="form-control" rows="3" name="keterangan" required><?php echo $row['isi'];?></textarea>
               ...
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="">
                                                <img src="../upload/<?php echo $row['gambar']; ?>" style="    
                                                    width: 4cm;
                                                    height: 6cm;
                                                    margin-left: -36px;
                                                    float: left;">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file"  name="foto" id="foto" value="../upload/<?php echo $row['gambar']; ?>" ></span>
...
if (empty(basename($_FILES["foto"]["name"]))) {
    ...
    $tanggal = date("Y-m-d");
     $sql = "UPDATE tb_event SET  `nama` = '$nama',`tgl_berlaku` = '$tanggal_mulai',`tgl_berakhir` = '$tanggal_selesai',`isi` = '$keterangan',`tanggal`='$tanggal' WHERE id = $id";
     $result = mysqli_query($conn, $sql);
...
// if everything is ok, try to upload file
    ...
    $keterangan   = $_POST['keterangan'];
    $tanggal = date("Y-m-d");
     $sql = "UPDATE tb_event SET  `nama` = '$nama',`tgl_berlaku` = '$tanggal_mulai',`tgl_berakhir` = '$tanggal_selesai',`isi` = '$keterangan',`tanggal`='$tanggal', `foto` ='$foto' WHERE id = $id";
     $result = mysqli_query($conn, $sql);
