...
?>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                    <li>
                        <a href="testimoni.php" class="active-menu"><i class="fa fa-comments-o "></i>TESTIMONI</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse" style="">
                            ...
                            <li>
                                <a href="setting_kuota.php"><i class="fa fa-code "></i>Edit Kuota</a>
                            </li>
                           </ul>
        ...
        <!-- /. NAV SIDE  -->
        <?php
        $jml=mysqli_query($conn,"SELECT COUNT(id)  FROM tb_testimoni ");
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">DATA TESTIMONI<span class="count" ><?php echo $jml[0];?></span></h1>
...
<?php 
    $qu=mysqli_query($conn,"SELECT * FROM tb_testimoni ORDER BY tanggal DESC");
    while($has=mysqli_fetch_row($qu)){
      if ($has[4]=='0') {
       $status = "<font style='color:#e74c3c;'>Belum Ditanggapi <font>";
      }else{
       $status = "<font style='color:#27ae60;'>Ditampilkan <font>";
      }
echo "
  <tr>
    <td><div id='etc'>$has[1]</div></td>
    <td>$has[2]</td>
    <td><img src=' ../upload/$has[3]'></td>
    <td>$status</td>
   
    <td>"?> <div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Action <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="acc.php?id=<?php echo $has[0];?>">Setuju</a></li>
                                            <li class="divider"></li>
                                            <li><a href="delete_testimoni.php?id=<?php echo $has[0];?>">Hapus</a></li>
                                        </ul>
                                    </div>
    <?php "</td>
  </tr>";
