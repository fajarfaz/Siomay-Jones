			...
			<div class="row">
				...
				<?php
				 function rupiah($angka){
					...
					$top =1 ;
					     $event=mysqli_query($conn,"SELECT * FROM tb_produk ORDER BY tanggal DESC  ");
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap">
					...
					<div class="fh5co-item animate-box" >
						<img src="upload/<?php echo $eventhas[7]; ?>" class="img-responsive" alt="<?php echo $eventhas[1]; ?>">
						<h3><?php echo $eventhas[1]; ?></h3>
						<span class="fh5co-price"><?php echo $rp; ?><sup>.00</sup></span>
						<font style="color: #95a5a6;"><?php echo $eventhas[3]; ?></font>

						<p><?php echo $eventhas[4]; ?></p>
					</div><?php
					$eventhas=mysqli_fetch_row($event) ?>
					<div class="fh5co-item animate-box" >
						<img src="upload/<?php echo $eventhas[7]; ?>" class="img-responsive" alt="<?php echo $eventhas[1]; ?>">
						<h3><?php echo $eventhas[1]; ?></h3>
						<span class="fh5co-price"><?php echo $rp; ?><sup>.00</sup></span>
