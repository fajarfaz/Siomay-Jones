                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in" style="">
                            ...
                            <li>
                                <a href="data_galeri.php" class="active-menu"><i class="fa fa-edit "></i>Edit Data</a>
                            </li>
                           </ul>
                     <li>
                      <li>
               ...
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="">
                                                 <img src="../upload/<?php echo $row['nama_file']; ?>" style="    
                                                    width: 4cm;
                                                    height: 6cm;
                                                    margin-left: -23px;
                                                    float: left;">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file"  name="file" id="file" value="../upload/<?php echo $row['nama_file']; ?>" ></span>
...
if (isset($_POST['kirim'])){
  if (empty(basename($_FILES["file"]["name"]))) {
                ...
                $tanggal = date("Y/m/d");
                $sql = "UPDATE tb_galeri SET  `nama` = '$nama',`isi` = '$isi',`tanggal`='$tanggal' WHERE id = $id";
                 $result = mysqli_query($conn, $sql);
                 if ($result) 
                 {  
    ...
    if ((($type == "video/mp4") || ($type == "video/3gpp")  || ($type == "video/x-flv")) && ($size < 50000000 ))
    {
        ...
        {  
            ...
            if(move_uploaded_file($tmp_name,$nama_file_baru))
            {
                ...
                $isi   = $_POST['keterangan'];
                $tanggal = date("Y/m/d");
                 $sql = "UPDATE tb_galeri SET  `nama` = '$nama',`isi` = '$isi', `file` = '$file',`tanggal`='$tanggal' WHERE id = $id";
                 $result = mysqli_query($conn, $sql);
                 if ($result) 
                 {  
