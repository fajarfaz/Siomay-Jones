                 ...
                 <form action="" method="POST" enctype="multipart/form-data" >
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jk" value="<?php echo $row['jk'];?>" required>
                                        ...
                                        <div class="form-group">
                                            <label>Bagian </label>
                                            <input class="form-control" type="text" name="bagian" value="<?php echo $row['bagian'];?>" required>
                                            <p class="help-block">Masukkan Bagian pekerjaan</p>
                                        </div>   
                                         <div class="form-group">
                                            <label>Nomer Telepon Pegawai</label>
                                            <input class="form-control" type="text" name="telp" value="<?php echo $row['no_hp'];?>" required>
                                            <p class="help-block">Masukkan Nomor Telepon pegawai</p>
                                        </div>   
                                         <div class="form-group">
                                            <label>Quotes Pegawai</label>
                                            <input class="form-control" type="text" name="quotes" value="<?php echo $row['quote'];?>" >
                                             ...
                                             <img src="../upload/<?php echo $row['gambar']; ?>" style="    
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file"  name="file" id="file" value="../upload/<?php echo $row['gambar']; ?>" ></span>
