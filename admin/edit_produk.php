                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in" style="">
                            ...
                            <li>
                                <a href="data_produk.php" class="active-menu"><i class="fa fa-edit "></i>Edit Data</a>
                            </li>
                           </ul>
                     <li>
        ...
        <div id="page-wrapper">
                 ...
                 <form action="" method="POST" enctype="multipart/form-data" >
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="harga" min="1" max="1000000" value="<?php echo $row['harga'];?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="unik" value="<?php echo $row['unik'];?>" required>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        ...
                                                        value="../upload/<?php echo $row['gambar']; ?>" ></span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
                <div class="panel-body">
                      <div class="form-group">
                             <input type="submit" class="btn btn-lg btn-success" value="Simpan" name="kirim" style="float: right;">                     
             </form>
         </div>
...
if (empty(basename($_FILES["foto"]["name"]))) {
    ...
    $unik   = $_POST['unik'];
    $tanggal = date("Y/m/d");
     $sql = "UPDATE tb_produk SET  `nama` = '$nama',`harga` = '$harga',`kategori` = '$kategori',`isi` = '$keterangan',`tanggal`='$tanggal',`unik` = '$unik' WHERE id = $id";
     $result = mysqli_query($conn, $sql);
...
// if everything is ok, try to upload file
    ...
    $tanggal = date("Y-m-d H:i:s");
     $sql = "UPDATE tb_produk SET  `nama` = '$nama',`harga` = '$harga',`kategori` = '$kategori',`isi` = '$keterangan',`tanggal`='$tanggal',`gambar` = '$foto' WHERE id = $id";
     $result = mysqli_query($conn, $sql);
