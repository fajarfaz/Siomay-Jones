		...
		<div class="container">
			<div class="row">
				...
				<?php
					     ...
					     $event=mysqli_query($conn,"SELECT * FROM tb_galeri WHERE kategori='video' ORDER BY tanggal DESC  ");
   						 while($eventhas=mysqli_fetch_row($event)){
   						
   				?>
			<div class="col-md-3 col-sm-3 fh5co-gallery_item">
					<video width="100%" controls>
					  <source src="upload/<?php echo $eventhas[3];?>" type="video/mp4">
					  <source src="upload/<?php echo $eventhas[3];?>" type="video/ogg">
