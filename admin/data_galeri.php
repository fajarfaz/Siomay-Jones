...
?>
        ...
        <!-- /. NAV SIDE  -->
        <?php
        $jml=mysqli_query($conn,"SELECT COUNT(id)  FROM tb_galeri ");
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">DATA GALERI<span class="count" ><?php echo $jml[0];?></span></h1>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Pencarian Berdasarkan Judul konten..." title="Tulis Dengan Angka..." >
<table id="myTable">
  <tr class="header">
...
<?php 
    $qu=mysqli_query($conn,"SELECT * FROM tb_galeri ");
...
echo "
  <tr>
    ...
    <td><div id='etc'>$has[5] Kali</div></td>
    <td>"?> <div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Action <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="edit_galeri.php?id=<?php echo $has[0];?>">Edit</a></li>
                                            <li class="divider"></li>
                                            <li><a href="delete_galeri.php?id=<?php echo $has[0];?>">Hapus</a></li>
                                        </ul>
                                    </div>
    <?php "</td>
  </tr>";
