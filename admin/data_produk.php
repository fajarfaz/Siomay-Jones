...
?>
        ...
        <!-- /. NAV SIDE  -->
         <?php
        $jml=mysqli_query($conn,"SELECT COUNT(nama)  FROM tb_produk ");
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">DATA PRODUK<span class="count" ><?php echo $jml[0];?></span></h1>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Pencarian Berdasarkan Nama Produk..." title="Tulis Dengan Angka..." >
<table id="myTable">
  <tr class="header">
...
<?php 
  function rupiah($angka){
    ...
    $qu=mysqli_query($conn,"SELECT * FROM tb_produk ORDER BY tanggal DESC");
    while($has=mysqli_fetch_row($qu)){

$rp =rupiah($has[2]);
$date = date_create($has[6]);
$tanggal = date_format($date,'M d Y');

echo "
  <tr>
    <td><div id='etc'>$has[1]</div></td>
    <td><div id='etc'>$rp</div></td>
    <td>$has[3]</td>
    <td><div id='etc'>$has[4]</div></td>
    <td><img src=' ../upload/$has[7]'></td>
    <td>$tanggal</td>
    <td>"?> <div class="btn-group">
            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Action <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a href="edit_produk.php?id=<?php echo $has[0];?>">Edit</a></li>
                                            <li class="divider"></li>
                                            <li><a href="delete_produk.php?id=<?php echo $has[0];?>">Hapus</a></li>
                                        </ul>
                                    </div>
    <?php "</td>
  </tr>";
